                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <svg
                        ...
                        xmlns="http://www.w3.org/2000/svg"
                      >
                        <g opacity="0.5" clipPath="url(#clip0_4778_1186)">
                          <path
                            d="M11.3586 12.4461C10.6055 12.7748 9.76259 12.8354 8.97033 12.6177C8.17807 12.4 7.48441 11.9172 7.00508 11.2499C6.54034 10.5913 6.32989 9.7866 6.41265 8.98477C6.49541 8.18295 6.86579 7.43824 7.45526 6.88843C8.05633 6.3265 8.8313 5.98671 9.65184 5.92533C10.4724 5.86395 11.2893 6.08466 11.9673 6.55091C12.636 7.00262 13.1191 7.68055 13.3279 8.46005C13.5366 9.23955 13.457 10.0682 13.1035 10.7937"
                            stroke="black"
                            strokeWidth="1.25"
                            strokeLinecap="round"
                          ...
                          />
                          <path
                            d="M11.4067 12.447L13.278 14.3183H14.3298V15.322H15.3568V16.3525L15.8337 16.8295H17.3945V15.327L13.0391 10.9717"
                            stroke="black"
                            strokeWidth="1.25"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                          <path
                            d="M8.9143 9.36737C9.49341 9.36737 9.96287 8.8979 9.96287 8.31879C9.96287 7.73968 9.49341 7.27022 8.9143 7.27022C8.33519 7.27022 7.86572 7.73968 7.86572 8.31879C7.86572 8.8979 8.33519 9.36737 8.9143 9.36737Z"
                            stroke="black"
                            strokeWidth="1.25"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          />
                          <path
                            d="M11.8945 21.2267C17.3368 21.2267 21.7486 16.8149 21.7486 11.3726C21.7486 5.93027 17.3368 1.51841 11.8945 1.51841C6.45214 1.51841 2.04028 5.93027 2.04028 11.3726C2.04028 16.8149 6.45214 21.2267 11.8945 21.2267Z"
                            stroke="black"
                            strokeWidth="1.25"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        ...
                        <defs>
                          <clipPath id="clip0_4778_1186">
                            <rect
                              width="22"
                              height="22"
                              fill="white"
                              transform="translate(0.894531 0.372578)"
                            />
                          </clipPath>
                        </defs>
                      </svg>
